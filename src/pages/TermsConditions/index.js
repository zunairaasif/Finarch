...
const TermsConditions = () => {
  return (
    <Grid>
      <Navbar />
      <Grid gap={2} container sx={styles.termsConditions}>
        ...
        <Typography variant="body1">
          Other than the content you own, under these Terms, Finarch and/or its
        ...
        <Typography variant="body1">
          ...
          and Finarch may further restrict access by you to any areas of this
        ...
        <Typography variant="body1">
          ...
          display on this Website. By displaying Your Content, you grant Finarch
        ...
        <Typography variant="body1">
          ...
          third-party's rights. Finarch reserves the right to remove any of Your
          Content from this Website at any time without notice.
        </Typography>

        <Typography variant="h5">No warranties</Typography>
        <Typography variant="body1">
          This Website is provided "as is," with all faults, and Finarch express
          ...
          <ul>
            ...
            <li style={styles.gap}>
              <Typography variant="body1">
                ...
                or "Our" in this Agreement) refers to Finarch, E-86/11 T.S
                Building Defence, D.H.A. Main Blvd, Punjab.
              </Typography>
            </li>
            <li style={styles.gap}>
              <Typography variant="body1">
        ...
        <Box gap={1}>
          ...
          <Typography variant="body1">
            ...
            reimburse you no later than 14 days from the day on which We receive
            the returned Goods. We will use the same means of payment as You
        ...
        <Box gap={1}>
          ...
          <ul>
            ...
            <li>
              <Typography>
                All Digital Items and Products. Like Softwares, Blueprints etc.
              </Typography>
            </li>
          </ul>
          <Typography variant="body1">
        ...
        <Typography variant="body1">
          ...
          under contract. Finarch, including its officers, directors and
        ...
        <Typography variant="body1">
          Finarch is permitted to revise these Terms at any time as it sees fit,
        ...
        <Typography variant="body1">
          The Finarch is allowed to assign, transfer, and subcontract its rights
        ...
        <Typography variant="body1">
          These Terms constitute the entire agreement between Finarch and you in
        ...
        <Typography variant="body1">
          ...
          laws of the State of pk, and you submit to the non-exclusive
