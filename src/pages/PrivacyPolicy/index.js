...
const PrivacyPolicy = () => {
  return (
    <Grid>
      <Navbar />
      <Grid gap={2} container sx={styles.privacy}>
        ...
        <Typography variant="body1">
          ...
          by finarch.co and how we use it.
        </Typography>
        <Typography variant="body1">
        ...
        <Typography variant="body1">
          This Privacy Policyapplies only to our online activities and is valid
          for visitors to our website with regards to the information that they
          shared and/or collect in finarch.co. This policy is not applicable to
        ...
        <Typography variant="body1">
          ...
          advertisements and links that appear on finarch.co, which are sent
